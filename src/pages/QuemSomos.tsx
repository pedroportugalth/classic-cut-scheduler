          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                Há mais de uma década, The Classic Cut é sinônimo de excelência em barbearia. 
                Combinamos a tradição das técnicas clássicas com a sofisticação moderna para 
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
              ...
              >
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    Fundada em 2010, The Classic Cut nasceu do sonho de criar um espaço onde o 
                    cuidado masculino fosse elevado a uma verdadeira arte. Nosso fundador, com 
                    mais de 20 anos de experiência, trouxe para nossa barbearia o melhor das 
                    técnicas tradicionais europeias.
                  </p>
                  <p>
                    Ao longo dos anos, formamos uma equipe de profissionais apaixonados que 
                    compartilham nossa visão: cada cliente que entra pela nossa porta merece 
                    uma experiência excepcional, do início ao fim.
                  </p>
                  <p>
                    Hoje, somos reconhecidos como referência em qualidade e atendimento, 
                    mas nunca esquecemos nossas raízes. Mantemos viva a tradição da barbearia 
                    clássica enquanto abraçamos a inovação.
                  </p>
                </div>
              </motion.div>
            ...
            <div className="max-w-3xl mx-auto">
              {timeline.map((item, index) => (
                ...
                >
                  ...
                  <span className="inline-block text-gold font-display text-2xl font-bold mb-2">
                    {item.year}
                  </span>
                  <h3 className="font-display text-xl font-semibold mb-2 text-foreground">
                    {item.title}
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
                Venha conhecer nosso espaço e descubra por que milhares de clientes 
                confiam em nós há mais de uma década.
              </p>
              <a
                href="/agendamento"
